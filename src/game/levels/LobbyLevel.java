...
/**
 * <h1>LobbyLevel class.</h1>
 * The class of the level Lobby. Extends Level class.
 * This class builds and sets variables for player, mobs and checkpoint.
 *
 * @author Kevin Ngo
 */
class LobbyLevel extends Level {
    LobbyLevel(int gameCanvasWidth, int gameCanvasHeight) {
        // General Level variables
        final Levels nextLevel = Levels.OFFICE;
        ...
        final int windowBoundTop = 80;
        final int windowBoundBottom = 345;
        ...
        final int mobOnePositionYTwo = 340;
        final int mobTwoPositionYOne = 200;
        final int mobTwoPositionYTwo = 300;
        final int mobThreePositionYOne = 100;
        final int mobThreePositionYTwo = 250;
        ...
        // Build default level
        Image backgroundImage = new Image(getClass().getResource("/images/levelFour.png").toString());
