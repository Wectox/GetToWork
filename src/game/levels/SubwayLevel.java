...
/**
 * <h1>SubwayLevel class.</h1>
 * The class of the level Subway. Extends Level class.
 * This class builds and sets variables for player, mobs and checkpoint.
 *
 * @author Emil Jensen
 */
class SubwayLevel extends Level {

    SubwayLevel(int gameCanvasWidth, int gameCanvasHeight) {
        // The next level
        final Levels nextLevel = Levels.STREET;
        ...
        final int playerStartPositionX = 140;
        final int playerStartPositionY = 200;

        // Level variables
        final int windowBoundLeft = 125;
        ...
        final int mobTwoStartPositionY = 50;
        ...
        final int mobTwoPositionYOne = 100;
        final int mobTwoPositionYTwo = 300;
        ...
        // Build default level
        Image backgroundImage = new Image(getClass().getResource("/images/levelOne.png").toString());
