...
/**
 * <h1>OfficeStreetLevel class.</h1>
 * The class of the level OfficeStreet. Extends Level class.
 * This class builds and sets variables for player, mobs and checkpoint.
 *
 * @author Kevin Ngo
 */
class OfficeStreetLevel extends Level {

    OfficeStreetLevel(int gameCanvasWidth, int gameCanvasHeight) {
        // General Level variables
        final Levels nextLevel = Levels.LOBBY;
        ...
        final int windowBoundRight = 525;
        ...
        final int checkpointPositionY = 200;

        // Build default level
        Image backgroundImage = new Image(getClass().getResource("/images/levelThree.png").toString());
